...
#ifndef PIXELFLOW_SWIFT_H
#define PIXELFLOW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PixelFlow",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9PixelFlow11AppDelegate")
...
SWIFT_CLASS("_TtC9PixelFlow21GenerationCoordinator")
@interface GenerationCoordinator : NSObject
...
SWIFT_CLASS("_TtC9PixelFlow13MetalRenderer")
...
SWIFT_CLASS("_TtC9PixelFlow21ParticleSystemAdapter")
@interface ParticleSystemAdapter : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9PixelFlow25ParticleSystemCoordinator")
@interface ParticleSystemCoordinator : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC9PixelFlow13SceneDelegate")
...
@class NSString;
@class NSBundle;
SWIFT_CLASS("_TtC9PixelFlow14ViewController")
