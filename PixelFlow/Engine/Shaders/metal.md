...
Обзор использования Metal в проекте PixelFlow для высокопроизводительной визуализации частиц.

## Обзор

PixelFlow использует Metal - низкоуровневый графический и вычислительный API от Apple - для реализации системы частиц в реальном времени. Metal обеспечивает прямой доступ к GPU, позволяя достигать максимальной производительности на устройствах Apple.
...
- **iOS 12.0+** - Минимальная версия для Metal
- **macOS 10.14+** - Поддержка Metal на Mac
