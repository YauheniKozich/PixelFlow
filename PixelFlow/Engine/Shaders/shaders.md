...
- Примечание: все позиции частиц теперь в **NDC [-1,1]**, `screenSize` больше не используется
...
- **Core/Utils.h** - вспомогательные функции (hash, noise, turbulentMotion с пространственной корреляцией)
